package edu.ucsb.cs56.drawings.marcellis.simple;
...
/**
   ...
   @author Marcellis Carr-Barfield (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Snowman Drawing by Marcellis Carr-Barfield", 20,20);
