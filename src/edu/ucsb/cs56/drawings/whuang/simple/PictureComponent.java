package edu.ucsb.cs56.drawings.whuang.simple;
...
/**
   ...
   @author Winfred Huang (fixed the snowmans's head)
...
{  
	...
	Circle snowManTopCircle =
	    ...
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY - bottomRadius * 3 - topRadius * 2, // need to fix
	     topRadius
	     );
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Winfred Huang's drawing of a house and snowman", 20,20);
