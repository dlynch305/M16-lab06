...
public class PhoneWithButtons extends Phone implements Shape
{
	...
	// Make three buttons, spaced like this, where width is between the phone bezels
	// | +----+----+----+ |
	// | |    |    |    | |
	// | +----+----+----+ |
	// |   b1   b2   b3   |
	//
	// The button starting position is 
	// the height of each button is screen height times 0.15;
